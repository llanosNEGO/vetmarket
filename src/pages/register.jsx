                            ...
                            <div>
                                ...
                                <div className="mt-1">
                                    <input
                                        ...
                                        className="appearance-none block w-full bg-gray-200 px-3 py-2 border border-gray-200 rounded-md placeholder-gray-400 focus:outline-none focus:ring-[var(--primary)] focus:border-[var(--primary)] sm:text-sm"
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="appearance-none block w-full text-black bg-gray-200 px-3 py-2 border border-gray-200 rounded-md placeholder-gray-400 focus:outline-none focus:ring-[var(--primary)] focus:border-[var(--primary)] sm:text-sm"
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="appearance-none block w-full px-3 text-black bg-gray-200 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-[var(--primary)] focus:border-[var(--primary)] sm:text-sm"
                            ...
                            <div>
                                ...
                                <div className="mt-1">
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className="appearance-none block w-full px-3 py-2 text-black bg-gray-200 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-[var(--primary)] focus:border-[var(--primary)] sm:text-sm"
